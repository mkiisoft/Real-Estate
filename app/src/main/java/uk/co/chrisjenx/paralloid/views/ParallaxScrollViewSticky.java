 ...
 * Project: Paralloid
 */
public class ParallaxScrollViewSticky extends ScrollView implements Parallaxor {
    ...
    public ParallaxScrollViewSticky(Context context) {
        super(context);
        init();
    }

    public ParallaxScrollViewSticky(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ParallaxScrollViewSticky(Context context, AttributeSet attrs, int defStyle) {
