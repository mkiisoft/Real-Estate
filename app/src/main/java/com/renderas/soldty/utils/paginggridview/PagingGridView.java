...
import com.renderas.soldty.utils.paginggridview.LoadingView;
import com.renderas.soldty.utils.paginggridview.PagingBaseAdapter;

import java.util.List;


public class PagingGridView extends com.renderas.soldty.utils.paginggridview.HeaderGridView {
	...
	private com.renderas.soldty.utils.paginggridview.LoadingView loadinView;
	...
	public void onFinishLoading(boolean hasMoreItems, List<? extends Object> newItems) {
		...
		if(newItems != null && newItems.size() > 0) {
			...
			if(adapter instanceof com.renderas.soldty.utils.paginggridview.PagingBaseAdapter) {
