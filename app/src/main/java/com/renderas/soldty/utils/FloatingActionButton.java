...
import uk.co.chrisjenx.paralloid.views.ParallaxScrollView.OnScrollViewListener;
...
public class FloatingActionButton extends ImageButton {
  ...
  public void attachToScrollView(@NonNull ParallaxScrollView scrollView) {
      attachToScrollView(scrollView, null);
  }
  
  public void attachToScrollView(@NonNull ParallaxScrollView scrollView, ScrollDirectionListener listener) {
      ScrollViewScrollDetectorImpl scrollDetector = null;
      scrollDetector.setListener(listener);
      scrollDetector.setScrollThreshold(mScrollThreshold);
      //scrollView.setOnScrollViewListener(scrollDetector);
